...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/gongpengyang/Friends"
  ...
  s.source       = { :git => "https://github.com/gongpengyang/Friends.git", :tag => s.version.to_s }
  ...
  s.source_files  = "Friends/Friends/**/*.{h,m,swift}"
